		...
		<div className="bg-white rounded-lg p-6 shadow-sm">
			...
			<div className="space-y-4">
				...
				{hasData ? (
					...
					<div className="h-64 flex flex-col items-center justify-center text-center text-muted-foreground border border-dashed rounded-md">
						<p className="text-sm font-medium">No data available</p>
						<p className="text-xs">
							Performance trends will appear once data is collected.
						</p>
					</div>
				)}
			</div>
