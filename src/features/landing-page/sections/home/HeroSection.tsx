...
export const HeroSection = () => {
	return (
		<section
			className="font-poppins min-h-[90vh] w-full  bg-light-yellow bg-cover bg-center flex relative bg-[url('/images/hero-section-bg.png')]"
			style={{
				backgroundImage: "url('/images/hero-section-bg.png')",
				backgroundRepeat: "no-repeat"
			}}
		>
			<div className="w-full lg:w-[50dvw] grid place-items-center min-h-full">
				<div className="w-[390px] h-[385px] flex flex-col gap-y-10">
					<div>
					...
					<Link
						href="/signup"
						className="shadow-sm bg-light-blue rounded-[6px] border-none outline-none py-2 px-4 w-[130px] text-white uppercase lg:w-[229px] h-[56px] flex items-center justify-center"
					>
						get started
					</Link>
					{/* Download Buttons */}
