...
// 		setHour(newHour)
// 		onChange(formatTime(newHour, minute, period as TimeVariant))
// 	}

// 	const handleMinuteChange = (newMinute: number) => {
// 		setMinute(newMinute)
// 		onChange(formatTime(hour, newMinute, period as TimeVariant))
// 	}
...
// 	const handleOk = () => {
// 		onChange(formatTime(hour, minute, period as TimeVariant))
// 		onClose()
// 	}
...
// 		const angle = (value * 360) / max - 90 // -90 to start from 12 o'clock
...
// 					<div
// 						className="text-4xl font-bold text-purple-600 px-3 py-2 cursor-pointer hover:bg-purple-200 bg-purple-200 rounded"
// 						onClick={() => {}}
// 					>
...
// 					<div
// 						className="text-4xl font-bold text-black px-3 py-2 cursor-pointer hover:bg-gray-200 bg-gray-200 rounded"
// 						onClick={() => {}}
// 					>
...
// 							x1="96"
// 							y1="96"
// 							x2={96 + hourPosition.x}
// 							y2={96 + hourPosition.y}
// 							stroke="#7c3aed"
// 							strokeWidth="3"
// 							strokeLinecap="round"
// 						/>
...
// 						{/* Hour selector dot */}
// 						<circle
// 							cx={96 + hourPosition.x}
// 							cy={96 + hourPosition.y}
// 							r="6"
// 							fill="#7c3aed"
